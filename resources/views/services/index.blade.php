...
@section('content')
    ...
    <div class="bg-blue-600 text-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-4xl font-bold">Layanan Desa</h1>
            <p class="text-xl mt-2">Informasi layanan administratif dan publik desa</p>
        </div>
    </div>
                            ...
                            <div class="space-y-2 mb-4">
                                @if ($service->processing_time)
                                    <div class="flex items-center text-sm text-gray-600">
                                        ...
                                        <span>Waktu: {{ $service->processing_time }}</span>
                                    </div>
                                @endif
                                @if ($service->cost)
                                    <div class="flex items-center text-sm text-gray-600">
