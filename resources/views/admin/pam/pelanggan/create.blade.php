...
@section('title', 'Tambah Pelanggan PAM')

@section('content')
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Tambah Pelanggan PAM</h1>
    </div>

    <div class="rounded-lg bg-white p-6 shadow">
        <form action="{{ route('admin.pam.pelanggan.store') }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div class="mb-4">
                    ...
                    <input type="text" name="nomor_meteran" id="nomor_meteran" value="{{ old('nomor_meteran') }}"
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                <div class="mb-4">
                    ...
                    <input type="text" name="rt" id="rt" value="{{ old('rt') }}" placeholder="001"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="rw" id="rw" value="{{ old('rw') }}" placeholder="001"
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div class="mb-4">
                    ...
                    <input type="number" name="tarif_per_m3" id="tarif_per_m3" value="{{ old('tarif_per_m3', 0) }}"
                        min="0" step="100"
            ...
            <div class="mb-6">
                ...
                <textarea name="catatan" id="catatan" rows="2"
                    class="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-blue-500 focus:ring-blue-500 @error('catatan') border-red-500 @enderror">{{ old('catatan') }}</textarea>
                @error('catatan')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
